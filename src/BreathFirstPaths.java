...
//=================================================================================
	...
	/*
	 * constructor of the BFS object. When we create a BFS object, we are passing a
	 * person as a parameter(s). So when we use methods like distTo, hasPathTo...
	 * that also use a person as an in parameter(v) we are looking for the
	 * information between those two persons (s and v)
	 */
